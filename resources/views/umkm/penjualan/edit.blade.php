                        ...
                        <div class="col-md-3">
                            <div class="form-group-custom">
                                ...
                                <select id="pembeli_tomselect" name="pembeli" class="input-custom" placeholder="Ketik nama / no. telp / instansi...">
                                    ...
                                    @php $currentTeks = old('pembeli', $penjualan->pembeli); @endphp
                                    @if($currentTeks && !collect($pelanggan)->contains('nama_pelanggan', $currentTeks))
                                        <option value="{{ $currentTeks }}" selected>{{ $currentTeks }}</option>
                                    @endif
                                    @if(isset($pelanggan))
                                        @foreach($pelanggan as $plg)
                                            ...
                                            @endphp
                                            <option value="{{ $plg->nama_pelanggan }}" {{ $currentTeks == $plg->nama_pelanggan ? 'selected' : '' }}>{{ $optText }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
