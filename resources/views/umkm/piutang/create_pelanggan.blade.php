...
.upload-zone .preview-img { max-height: 120px; object-fit: contain; display: none; }
...
<div class="mb-4">
    ...
    <h1 class="h3 mb-0">Tambah <strong>Pelanggan Baru</strong></h1>
    <p class="text-muted" style="font-size:.78rem;margin-top:2px;">Isi profil pelanggan dan kontak untuk manajemen pencatatan.</p>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card border-0 shadow-sm mb-4">
            <div class="form-body">
                <form method="POST" action="{{ route('umkm.etalase.pelanggan.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="upload-zone" id="ktpZone">
                                ...
                                <div class="placeholder-content">
                                    ...
                                    <div style="font-size:.78rem;font-weight:600;color:#475569;">Klik / Seret foto KTP</div>
                                    <div style="font-size:.7rem;color:#94a3b8;">Format: JPG, PNG (Max 2MB)</div>
                                </div>
                                <img src="" class="preview-img" id="ktpPreview" alt="Preview KTP">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mb-2">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="alamat" class="form-control" rows="2"
                                      placeholder="Alamat domisili atau pengiriman...">{{ old('alamat') }}</textarea>
                        </div>
                        <div class="col-12">
