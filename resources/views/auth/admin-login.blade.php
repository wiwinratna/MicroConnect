    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-left::before {
            ...
            background: radial-gradient(circle, rgba(14, 165, 233, 0.08) 0%, transparent 60%); border-radius: 50%; pointer-events: none;
        }
        ...
        .tagline h2 { font-size: 1.25rem; font-weight: 600; color: #f0f9ff; margin-bottom: 8px; letter-spacing: -0.02em; }
        .tagline p { font-size: 0.85rem; color: #bae6fd; max-width: 280px; margin: 0 auto; line-height: 1.5; }
        ...
        .greeting-badge {
            display: inline-block; background: #e0f2fe; color: #0369a1; padding: 4px 10px; border-radius: 6px;
        ...
        .remember-check input[type="checkbox"] { width: 14px; height: 14px; accent-color: #0284c7; cursor: pointer; }
        .remember-check label { font-size: 0.8rem; color: #64748b; cursor: pointer; }

        .btn-login {
            width: 100%; padding: 11px 20px; background: #0284c7; color: #fff; border: none; border-radius: 8px;
            font-size: 0.9rem; font-weight: 600; cursor: pointer; transition: all 0.2s ease; box-shadow: 0 2px 4px rgba(2, 132, 199, 0.2);
        }
        .btn-login:hover { background: #0369a1; box-shadow: 0 4px 8px rgba(2, 132, 199, 0.3); transform: translateY(-1px); }

        .security-note { text-align: center; margin-top: 24px; padding: 8px 12px; background: #fef9c3; border: 1px solid #fef08a; border-radius: 6px; font-size: 0.7rem; color: #a16207; line-height: 1.4; }
    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            ...
            <div class="lottie-container anim d-1">
                <lottie-player src="{{ asset('assets/lottie/login-admin.json') }}" background="transparent" speed="1" loop autoplay></lottie-player>
            </div>
            <div class="tagline anim d-2">
                <h2>Panel KADIN</h2>
                <p>Pantau performa, kesehatan, dan pertumbuhan UMKM binaan secara komprehensif.</p>
            </div>
        </div>
        ...
        <div class="login-right">
            <div class="login-form-wrapper">
                <div class="form-header anim">
                    <span class="greeting-badge">Administrator Access</span>
                ...
                <form method="POST" action="{{ route('admin.login.process') }}">
                    ...
                    <div class="form-group anim d-1">
                        ...
                        <input class="form-input" type="email" name="email" value="{{ old('email') }}" placeholder="admin@kadin.bengkalis" required autofocus />
                    </div>

                    <div class="form-group anim d-2">
                        <label class="form-label">Kata Sandi</label>
                        <div class="password-wrapper">
                            <input class="form-input" type="password" name="password" id="passwordInput" placeholder="Masukkan kata sandi" required />
                    ...
                    <div class="form-options anim d-2">
                        <label class="remember-check">
                            ...
                            <span>Biarkan saya tetap login</span>
                        </label>
                    </div>

                    <button type="submit" class="btn-login anim d-3">Masuk ke Panel</button>
                </form>

                <div class="security-note anim d-3">
                    🔐 Akses terbatas hanya untuk pengurus sah KADIN.<br>Setiap aktivitas akan dicatat dalam log sistem.
                </div>

                <div class="footer-text anim d-3">
                    © {{ date('Y') }} MINECT · Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </div>
